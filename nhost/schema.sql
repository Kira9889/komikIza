...
-- ------------------------------------------------------------
-- MEMBERS (menggabungkan profil user; id menyambung ke auth.user)
-- Nhost menyediakan tabel `auth.users`. Kita tambahkan metadata
-- publik untuk role user/admin.
-- ------------------------------------------------------------
