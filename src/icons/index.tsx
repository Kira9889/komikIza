...
export function LibraryIcon(props: IconProps) {
  return (
    <svg {...base(props)}>
      <path d="M3 4a1 1 0 0 1 1-1h4a1 1 0 0 1 1 1v16a1 1 0 0 1-1 1H4a1 1 0 0 1-1-1V4Z" />
      <path d="M15 4a1 1 0 0 1 1-1h4a1 1 0 0 1 1 1v16a1 1 0 0 1-1 1h-4a1 1 0 0 1-1-1V4Z" />
      <path d="M8 7h5" /><path d="M8 12h5" />
    </svg>
  )
}
...
export function StarIcon(props: IconProps) {
  return <svg {...base(props)} fill="currentColor" stroke="none"><path d="m12 2 3.09 6.26L22 9.27l-5 4.87 1.18 6.88L12 17.77l-6.18 3.25L7 14.14 2 9.27l6.91-1.01L12 2Z" /></svg>
}
...
export function EditIcon(props: IconProps) {
  return <svg {...base(props)}><path d="M17 3a2.83 2.83 0 1 1 4 4L7.5 20.5 2 22l1.5-5.5L17 3Z" /></svg>
}

export function TrashIcon(props: IconProps) {
  return <svg {...base(props)}><path d="M3 6h18" /><path d="M19 6v14a2 2 0 0 1-2 2H7a2 2 0 0 1-2-2V6" /><path d="M8 6V4a2 2 0 0 1 2-2h4a2 2 0 0 1 2 2v2" /></svg>
}
